...
disp(' ----- JEDI TRAINING ------'); 
tic; [ListSet,patchInfo] = trainingDataAndLabels_v14_intraPatchInterPatch(META,META.trainingLimits); toc;
...
META=startUp();
disp(' ----- LA VALIDATION ------'); 
[valListSet,testPatchInfo] = validatingDataAndLabels_v13_intraPatchInterPatch(META);
...
META=startUp();
disp(' ----- TESTING TIME ------'); 
[testListSet,testFinalPatchInfo] = testingDataAndLabels_v13_intraPatchInterPatch(META);
