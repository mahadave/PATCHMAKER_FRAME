function [ListSet,patchInfo] = trainingDataAndLabels_v14_intraPatchInterPatch(META,limits)
    ...
    for imgIndex = lowerLim:upperLim
        ...
        [patchInfo,ListSet]=makePatches_v3(KDE_STRUCT,ListSet,patchInfo,imgIndex,probThreshold,META);
